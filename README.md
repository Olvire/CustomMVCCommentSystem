...
How to Run:
	1-> Unzip the code to you server web root directory
	2-> Create new MySQL database using sql dump file inside sql(directory)
	3-> Change the DB config in config/Config.php
	4-> Run the application using web browser. 
Features:
